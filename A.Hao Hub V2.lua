...
v0.new("<Color=Cyan>Hi Everyone<Color=/>"):Display();
wait(0.5);
v0.new("<Color=Yellow>Welcome A.Hao Hub<Color=/>"):Display();
wait(1);
repeat
    wait();
...
v5.Window = function(v134, v135)
	...
	v170.Image = "https://cdn.discordapp.com/attachments/1424207358686531664/1428146254461800499/Screenshot_2025-10-06-12-26-00-81_572064f74bd5f9fa804b05334aa4f912.jpg?ex=68f41358&is=68f2c1d8&hm=117f9c04912cecd4dd5e0def7753066b367ce0adfff64d3ca6046b169cd8cd9d&"   .. tostring(1427990749739483147) ;
